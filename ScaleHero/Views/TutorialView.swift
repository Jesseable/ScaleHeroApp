...
struct TutorialView: View {
    ...
    func infoText() -> String {
        ...
        Scales can be customized as follows:
            ...
            b.  Scale selection (All recognized scales, inculding Major, Natural minor, Harmonic minor, Melodic minor, Modes, Arpeggios, etc.);
            b.  Adjustment of tempo, time signature, starting note, starting octave, number of octaves, repetition of tonic note;
            c.  Selection/addition of drone (cello or tuning fork)
